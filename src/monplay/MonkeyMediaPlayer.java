...
/**
 * Uses utilities in the vlcj package to play a variety of audio and video media files. If an error
 * is encountered in playback, no media plays and the user can continue playing media files
 * normally.
 * 
 * @author marsalad
 * @see MediaPlayer
...
public class MonkeyMediaPlayer {
    ...
    /**
     * Creates an {@code AudioMediaPlayerComponent} and plays the given audio media file. The app is
     * unlocked upon completion of the audio stream or upon errors in playback.
     * 
    ...
    /**
     * Creates an {@code EmbeddedMediaPlayerComponent} and plays the given audio media file.
     * 
    ...
    /**
     * Creates an {@code EmbeddedMediaPlayerComponent} and plays the given audio media file once
     * multi-threading is invoked.
     * 
     * @param fileName name of video media file
     * @param c navigation controller to unlock
     */
