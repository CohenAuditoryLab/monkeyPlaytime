...
/**
 * {@code MonkeyMediaPanel} is a {@code MonkeyPanel} setup for a 2-by-3 grid of audio or video
 * buttons. It uses a {@code GridLayout} and {@code MonkeyPanelType} to specify the appearance and
 * behavior of buttons.
 * 
 * @author marsalad
 * @see MonkeyPanel
...
public class MonkeyMediaPanel extends MonkeyPanel {
    ...
    /**
     * Constructs a {@code MonkeyMediaPanel} with access to lock and unlock the app. The panel is
     * setup as a 2-by-3 grid of audio or video buttons.
     * 
    ...
    public MonkeyMediaPanel(MonkeyPanelType t, ActionController c) {
        super(t, c, 2, 3);
        if (t.equals(MonkeyPanelType.TASK)) { throw new IllegalArgumentException(); }
