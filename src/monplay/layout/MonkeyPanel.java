...
/**
 * {@code MonkeyPanel} is a lightweight {@code JPanel} with additional functionality for the
 * {@code Playtime} app. It uses a {@code GridLayout} and {@code MonkeyPanelType} to specify the
 * appearance and behavior of buttons.
 * 
 * @author marsalad
 * @see JPanel
 * @see MonkeyPanelType
...
public abstract class MonkeyPanel extends JPanel {
    ...
    /**
     * Constructs a {@code MonkeyPanel} with access to lock and unlock the app. The type and number
     * of buttons are specified by the user.
     * 
    ...
    /**
     * Creates and returns a back button that, upon being pressed will return the user to the home
     * tab by calling {@code back()}.
     * 
     * @return back button
     */
