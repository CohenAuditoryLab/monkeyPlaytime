...
/**
 * <p>
 * The {@code Playtime} class is a {@code Runnable} that initializes media variables in
 * {@code MonkeyPanelType}, discovers native dependencies for media playback using
 * {@code NativeDiscovery}, and creates and shows the GUI using {@code JTabbedPane}.
 * </p>
 * <p>
 * The app is locked to disable input during playback and users can freely navigate between the home
 * tab and media/task tabs. It includes an inner class {@code NavController} to safely manage this
 * functionality within external classes.
 * </p>
 * 
 * @author marsalad
 * @see JTabbedPane
...
public class Playtime implements Runnable {
    ...
    /**
     * Creates and initializes the data file for this session with basic information such as monkey
     * name, datetime, and file names of media files used for this session.
     * 
    ...
    /**
     * {@code ActionController} manages the lock and unlocked state of the app and enables
     * navigation to different tabs. Should be passed as an argument to external classes to enable
     * safe navigation and locking/unlocking. The controller also writes data to the session data
     * file when instructed by external classes.
     * 
     * @author marsalad
     */
    public class ActionController {
        ...
        /**
         * Creates the {@code ActionController} to manage the locked status of the app, navigation
         * across tabs, and saving action data to the specified file.
         * 
        ...
        /**
         * Returns if the app is unlocked or not. The app is unlocked if there is no media currently
         * being played.
         * 
        ...
        /**
         * Updates the current {@code MediaPlayer}. Should be called prior to playback of any media.
         * 
        ...
        /**
         * Sets the selected index for the main {@code JTabbedPane}. The index must be a valid tab
         * index.
         * 
